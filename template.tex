...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={1.0.0-4-ARTC},
		Template.Version.Hash={D9E10F04F29D77FFF4C8DEA09C8AB0A1},
	...
	pdfproducer={Template-Articulo v1.0.0 | (Pablo Pizarro R.) ppizarror.com},
...
\newcommand\subsection@cntformat{\thesubsection.\quad} % section-level
\newcommand\subsubsection@cntformat{\thesubsubsection.\quad} % section-level
\newcommand\subsubsubsection@cntformat{\thesubsubsubsection} % section-level
\makeatother

\ifthenelse{\equal{\dotaftersnum}{true}}{ % Agrega punto tras el número
	% \newcommand\subsubsubsection@cntformat{\thesubsubsection.\arabic{subsubsubsection}.} % section-level
