...
\subsectionanum{Listas y Enumeraciones}
	...
	\themulticoldepth\GLOBALenvmulticol

	\begin{multicols}{3}
		\begin{enumeratebf}[label=\alph*) ] % Fuente en negrita
			\item Peras \themulticoldepth\GLOBALenvmulticol
			\item Manzanas
			\item Naranjas
		\end{enumeratebf}
...
\insertimagemc[\label{img:anexo-2}]{test-image.png}{scale=0.19}{fixed2}{Imagen en anexo que usa todas las columnas}
