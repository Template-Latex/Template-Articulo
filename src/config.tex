...
\def\hfstyle {style1}              % Estilo header-footer (19 estilos)
...
\def\margingathercapttop {-0.7}    % Margen superior caption en gather [cm]
...
\def\apaciterefsep {2}             % Separación entre refs. {apacite} [pt]
...
\def\bibtexrefsep {2}              % Separación entre refs. {bibtex} [pt]
...
\def\abstractmarginbottom {0.5}    % Margen inferior abstract [cm]
...
\def\marginimagebottom {-0.2}      % Margen inferior figura [cm]
...
\def\marginlinenumbers {6}         % Margen izquierdo (\showlinenumbers) [pt]
...
\def\sitemsmargini {20}            % Margen ítems nivel 1 [pt]
\def\sitemsmarginii {17}           % Margen ítems nivel 2 [pt]
\def\sitemsmarginiii {0}           % Margen ítems nivel 3 [pt]
